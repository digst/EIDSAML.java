...
public class AssertionWrapper implements Serializable {
    ...
    private static final long serialVersionUID = -7000173526735865535L;
    ...
    public AssertionWrapper(Assertion assertion) throws InternalException {
        ...
        if (this.attributeValues.containsKey(Constants.EIDAS_ATTRIBUTE_NATURAL_PERSONIDENTIFIER)) {
            personalIdentifier = this.attributeValues.get(Constants.EIDAS_ATTRIBUTE_NATURAL_PERSONIDENTIFIER);
        }
    ...
    public String getAssuranceLevel() {
        return this.getAuthnContextClassRef();
    }
