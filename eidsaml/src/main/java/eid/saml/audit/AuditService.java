...
public class AuditService {
    ...
    private AuditLogger createAuditLogger(String auditLoggerClassName) throws InitializationException {
        ...
        try {
            ...
            throw new InitializationException(String.format("Cannot create AuditLogger, '%s' must have default constructor and implement 'eid.saml.audit.AuditLogger'", adapterClazz.getName()), e);
        }
    }
}
