...
public class Configuration {
    ...
    private boolean isAssuranceLevelSkipped = false;
    private String minimumAssuranceLevel = "substantial";
    ...
    private String assuranceLevelPrefix = "http://eidas.europa.eu/LoA/";
    ...
    public boolean isAssuranceLevelSkipped() {
        return isAssuranceLevelSkipped;
    }

    public void setAssuranceLevelSkipped(boolean isAssuranceLevelThreeAllowed) {
        this.isAssuranceLevelSkipped = isAssuranceLevelThreeAllowed;
    }

    public String getMinimumAssuranceLevel() {
        return minimumAssuranceLevel;
    }

    public void setMinimumAssuranceLevel(String minimumAssuranceLevel) {
    ...
    public static class Builder {
        ...
        public Configuration build() throws InternalException {
            ...
            configuration.servletRoutingPathPrefix = StringUtil.defaultIfEmpty(this.servletRoutingPathPrefix,"eidsaml");
            ...
            configuration.auditLoggerClassName = StringUtil.defaultIfEmpty(this.auditLoggerClassName, "eid.saml.audit.Slf4JAuditLogger");
    ...
    public boolean isAssuranceLevelSufficient(String value) {
        ...
        Integer i;
        try {
            i = GetNumericAssuranceLevelMapping(value);
        } catch (Exception ex) {
            return false;
        }

        return i >= GetNumericAssuranceLevelMapping(minimumAssuranceLevel);
    }    
    ...
    public int GetNumericAssuranceLevelMapping(String assuranceLevelString)
    {
        switch(assuranceLevelString.replace(assuranceLevelPrefix, ""))
        {
            case "low":            
            return 1;
            case "substantial":
