...
import eid.saml.util.Constants;
...
public class AuthnRequestService {
    ...
    public MessageContext<SAMLObject> createMessageWithAuthnRequest(boolean isPassive, boolean forceAuthn, String attributeProfile) throws InternalException, ExternalException, InitializationException {
        ...
        // Create AuthnRequest
        AuthnRequest newAuthnRequest = createAuthnRequest(destination, isPassive, forceAuthn, attributeProfile);
        ...
        signatureSigningParameters.setSigningCredential(EIDSAMLService.getCredentialService().getPrimaryBasicX509Credential());
        ...
        signatureSigningParameters.setSignatureAlgorithm(EIDSAMLService.getConfig().getSignatureAlgorithm());
    ...
    public AuthnRequest createAuthnRequest(String destination, boolean isPassive, boolean forceAuthn) throws InitializationException {
        return createAuthnRequest(destination, isPassive, forceAuthn, null);
    }

    public AuthnRequest createAuthnRequest(String destination, boolean isPassive, boolean forceAuthn, String attributeProfile) throws InitializationException {
