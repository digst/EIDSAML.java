    ...
    private Assertion decryptAssertion(EncryptedAssertion encryptedAssertion) throws InternalException, ExternalException {
        ...
        try {
            ...
            try {
                ...
                credentials.add(EIDSAMLService.getCredentialService().getPrimaryBasicX509Credential());

                BasicX509Credential secondaryBasicX509Credential = EIDSAMLService.getCredentialService().getSecondaryBasicX509Credential();
