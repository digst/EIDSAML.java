...
public class LogoutResponseService {
    ...
    private static LogoutResponse createLogoutResponse(String destination, LogoutRequestWrapper logoutRequest) throws InitializationException {
        ...
        issuer.setValue(EIDSAMLService.getConfig().getSpEntityID());
    ...
    private static LogoutResponse signResponse(LogoutResponse logoutResponse) {
        ...
        try {
            ...
            BasicX509Credential x509Credential = EIDSAMLService.getCredentialService().getPrimaryBasicX509Credential();
            ...
            signature.setKeyInfo(EIDSAMLService.getCredentialService().getPublicKeyInfo(x509Credential));
