...
public class AuditRequestUtil {
    ...
    public static AuditService.Builder createBasicAuditBuilder(HttpServletRequest request, String action, String description) throws InternalException {
        SessionHandler handler = EIDSAMLService.getSessionHandlerFactory().getHandler();
        return new AuditService
                .Builder()
                .withAuthnAttribute("ACTION", action)
                .withAuthnAttribute("DESCRIPTION", description)
                .withAuthnAttribute("IP", getAttributeFromRequest(request, EIDSAMLService.getConfig().getAuditRequestAttributeIP(), request.getRemoteAddr()))
                .withAuthnAttribute("PORT", getAttributeFromRequest(request, EIDSAMLService.getConfig().getAuditRequestAttributePort(), String.valueOf(request.getRemotePort())))
                .withAuthnAttribute("SESSION_ID", getAttributeFromRequest(request, EIDSAMLService.getConfig().getAuditRequestAttributeSessionId(), request.getSession().getId()))
                ...
                .withAuthnAttribute("USER", getAttributeFromRequest(request, EIDSAMLService.getConfig().getAuditRequestAttributeServiceProviderUserId(), request.getRemoteUser()))
