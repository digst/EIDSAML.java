...
public class TestConstants {
    ...
    public static final String SP_ROUTING_BASE = "eidsaml";
    ...
    public static final String SP_ASSERTION_CONSUMER_URL = "http://localhost:8080/eidsaml/assertionConsumer";
    public static final String SP_LOGOUT_REQUEST_URL = "http://localhost:8080/eidsaml/logout";
    public static final String SP_LOGOUT_RESPONSE_URL = "http://localhost:8080/eidsaml/logout/response";
