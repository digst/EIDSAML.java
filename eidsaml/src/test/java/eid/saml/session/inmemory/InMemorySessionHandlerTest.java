package eid.saml.session.inmemory;

import eid.saml.service.AssertionService;
import eid.saml.service.AuthnRequestService;
import eid.saml.session.AssertionWrapper;
import eid.saml.session.AuthnRequestWrapper;
import eid.saml.session.LogoutRequestWrapper;
import eid.saml.util.IdpUtil;
...
class InMemorySessionHandlerTest {
    ...
    void testStoreAuthnRequest() throws InternalException, InitializationException {
        AuthnRequestWrapper authnRequestWrapperOld = new AuthnRequestWrapper(createAuthnRequest(), REQUEST_URL);
        AuthnRequestWrapper authnRequestWrapperNew = new AuthnRequestWrapper(createAuthnRequest(), REQUEST_URL);
    ...
    void testStoreAuthnRequestTimeout() throws InternalException, InitializationException {
        AuthnRequestWrapper authnRequestWrapperInput = new AuthnRequestWrapper(createAuthnRequest(), REQUEST_URL);
    ...
    private AuthnRequest createAuthnRequest() throws InitializationException {
        ...
        return authnRequestService.createAuthnRequest(TestConstants.SP_ASSERTION_CONSUMER_URL, false, false);
    }
