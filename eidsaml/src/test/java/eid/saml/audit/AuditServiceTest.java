...
class AuditServiceTest {
    ...
    void testInvalidAuditLogInterface() {
        ...
        String expectedMessage = String.format("Cannot create AuditLogger, '%s' must have default constructor and implement 'eid.saml.audit.AuditLogger'", InvalidTestAuditLoggerNoInterface.class.getName());
