...
import eid.saml.service.BaseServiceTest;
...
public class AssertionValidationServiceTest extends BaseServiceTest {
    ...
    public void testValidateCorrectAssertion() throws Exception {
        ...
        AuthnRequest authnRequest = authnRequestService.createAuthnRequest(TestConstants.SP_ASSERTION_CONSUMER_URL, false, false);
